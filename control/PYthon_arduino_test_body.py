...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            part30= [landmarks[mp_pose.PoseLandmark.RIGHT_HEEL.value].x,landmarks[mp_pose.PoseLandmark.RIGHT_HEEL.value].y]
        ...
        #elbow
        right_elbow_angle = str(calculate_angle(part12, part14, part16))
        left_elbow_angle = str(calculate_angle(part11, part13, part15))
        
        #Shoulders1
        Shoulders1_Right = str(calculate_angle(part14, part12, part24))
        Shoulders1_left = str(calculate_angle(part13, part11, part23))


        #Shoulders2
        Shoulders2_Right = str(calculate_angle(part14, part12, part11))
        Shoulders2_left = str(calculate_angle(part13, part11, part12))
        
        # right_elbow_angle = float(right_elbow_angle)
        # right_elbow_angle = int(right_elbow_angle)
        # right_elbow_angle = "1" + str(right_elbow_angle)
